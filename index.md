...
**Rusty Car-go** is a car programmed in Rust that follows a black colored tape that absorbs light, and lights up a little LED while doing so. It consists of IR sensor, The car is powered by DC motors connected to an L298N motor driver, which controls the speed of the wheels, and a Raspberry Pi Pico receives data from both the sensor and the driver to control the robot's behavior. This project serves as a door to building more more creative and fun projects.
